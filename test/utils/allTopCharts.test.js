...
describe('allTopCharts.js', function(){
	...
	it('should fulfilled if country is invalid replace with US as default', function(){
		return allTopCharts('201401', 'ZZ').should.be.fulfilled;//.be.rejectedWith('Could not locate country');
	});
